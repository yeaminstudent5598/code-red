...
export default function DialogContentPage() {
    ...
    return (
        // <DialogContent className=" overflow-y-auto bg-gray-900 text-white rounded-lg">
        <DialogContent className="sm:max-w-[425px] md:max-w-[88vw] max-h-[90vh] overflow-hidden">

            <div className="overflow-y-auto max-h-[75vh] px-2">
                <DialogHeader>
                    <DialogTitle className="text-lg text-white text-center font-semibold">Create a Post</DialogTitle>
