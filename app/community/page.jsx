...
export default function GroupList() {
  ...
  return (
    <div className=" max-w-6xl min-h-screen bg-none shadow-lg rounded-lg mx-auto p-4">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold">Group</h2>
        <div className="flex space-x-2">
          <select className="border text-gray-200 border-gray-300 rounded px-3 py-2 text-sm">
            <option className="text-gray-200">Alphabetical</option>
          </select>
          <CreateCommunityButton />
        </div>
      </div>

      <div className="border-b border-gray-300 mb-4 flex space-x-4 text-sm *:text-white">
